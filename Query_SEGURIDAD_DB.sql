...
VALUES 
(1001, 1, 1124567897, 'Juan', 'Pérez', 'Av. Siempre Viva 742', 'Palermo', 'CABA'),
(1002, 2, 1189115499, 'Ana', 'Gómez', 'Calle Falsa 123', 'Belgrano', 'CABA'),
(1003, 1, 1174557800, 'Carlos', 'Martínez', 'Paseo de la Reforma 456', 'Merlo', 'Buenos Aires'),
(1004, 3, 1124487797, 'Laura', 'Sánchez', 'Boulevard de los héroes 789', 'Moreno', 'Buenos Aires'),
(1005, 2, 1199967891, 'José', 'Rodríguez', 'Plaza Central 12', 'Lanus', 'Buenos Aires');
...
VALUES 
('T001', 1, 1198765432, 'Pedro', 'Martínez', 'Av. Principal 123', 'Buenos Aires', 'Buenos Aires', 1),
('T002', 2, 1191234567, 'Lucía', 'Fernández', 'Calle de la Luz 456', 'Córdoba', 'Córdoba', 2),
('T003', 1, 1199876543, 'Javier', 'Gómez', 'Paseo de la Innovación 789', 'Rosario', 'Santa Fe', 0),
('T004', 3, 1193456789, 'Ana', 'Sánchez', 'Calle Verde 101', 'Mendoza', 'Mendoza', 0),
('T005', 2, 1192345678, 'Roberto', 'López', 'Boulevard del Sol 202', 'La Plata', 'Buenos Aires', 3);
